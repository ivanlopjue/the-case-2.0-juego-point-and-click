...
export class DatosComponent {
  ...
  textoPresentacion = "Te damos la bienvenida a The Case 2.0. Como jugador resolver el crimen que se a producido en esta empresa. Debes encontrar a la persona culpable además del lugar donde se produjo el crimen y el objeto que utilizó para ello. Mucha suerte, la necesitarás..."
