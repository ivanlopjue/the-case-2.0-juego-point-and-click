...
export class DatosComponent {
  ...
  textoIntro =
  "Bienvenido al emocionante mundo de la investigación criminal.<br> Te encuentras en el corazón de una empresa próspera, pero un crimen ha sacudido su tranquila fachada.<br> {NOMBRE}, tu misión es desentrañar el misterio y descubrir al culpable.<br> Una noche, en medio de una importante reunión de negocios, se produce un asesinato.<br> La víctima es un empleado clave de la empresa, y nadie parece tener una coartada sólida.<br> El ambiente está lleno de sospechas y secretos.<br> La alta dirección de la empresa ha recurrido a ti, un detective experto en resolver casos complejos, para que resuelvas este enigma.<br> Tu primera tarea es elegir una estancia dentro de la empresa, donde comenzará tu investigación.<br> Cada habitación tiene pistas ocultas y secretos por descubrir.<br> Dependiendo de tus elecciones, las pistas pueden variar y te acercarán al culpable. A continuación, deberás seleccionar un personaje.<br> Cada individuo tiene su propia historia, motivaciones y posibles conexiones con el crimen.<br> Escucha atentamente sus testimonios y observa su comportamiento, ya que podrían estar ocultando información crucial.<br> Finalmente, deberás elegir un objeto que se sospecha está relacionado con el crimen. Este objeto puede haber sido dejado en la escena del crimen o estar vinculado de alguna manera con el asesinato, debes fijarte bien ya que el cursor cambiará cuando estes encima del objeto oculto.<br> Investigar su origen y su papel en el caso te ayudará a encontrar la verdad.<br> Como pista te diremos que en el hall no puede haberse cometido el crimen...<br>Y recuerda, solo tendrás 3 oportunidades de realizar tu acusación, te deseamos suerte"

  textoPresentacion = "Te damos la bienvenida a The Case 2.0 Como jugador te han contratado para resolver el crimen que se ha producido en esta empresa. Debes encontrar a la persona culpable además del lugar donde se produjo el crimen y el objeto que utilizó para ello. Mucha suerte, la necesitarás..."
}
